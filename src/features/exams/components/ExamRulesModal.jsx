...
//   // كل ما الـ modal يتفتح من جديد، نصفّر الـ checkbox
//   useEffect(() => {
//     if (isOpen) setAgreed(false);
//   }, [isOpen]);

//   // قفل الـ modal بـ Escape key
//   useEffect(() => {
//     if (!isOpen) return;
...
//       {/* ── Modal panel ───────────────────────────────────── */}
//       <div
//         className="relative flex max-h-[85vh] w-full max-w-[560px] animate-[fade-scale-in_0.25s_ease_both] flex-col rounded-[var(--radius-lg)]"
//         style={{
...
//             onClick={onClose}
//             aria-label="Close"
//             className="flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-[var(--radius-sm)] transition-all duration-150"
//             style={{
//               color: "var(--color-text-muted)",
//               backgroundColor: "transparent",
//               border: "none",
...
//           {/* Agreement checkbox */}
//           <label
//             className="flex cursor-pointer items-start gap-2.5 rounded-[var(--radius-sm)] p-3 transition-all duration-150"
//             style={{
//               backgroundColor: agreed
//                 ? "var(--color-primary-glow)"
//                 : "var(--color-surface-2)",
...
//             <button
//               onClick={onClose}
//               className="flex-1 cursor-pointer rounded-[var(--radius-sm)] py-2.5 text-sm font-medium transition-all duration-150"
//               style={{
//                 backgroundColor: "transparent",
//                 border: "1px solid var(--color-border)",
//                 color: "var(--color-text-muted)",
...
//               onClick={onConfirm}
//               disabled={!agreed}
//               className="flex-[2] cursor-pointer rounded-[var(--radius-sm)] py-2.5 text-sm font-semibold transition-all duration-150 disabled:cursor-not-allowed"
//               style={{
//                 backgroundColor: agreed
//                   ? "var(--color-primary)"
//                   : "var(--color-surface-2)",
